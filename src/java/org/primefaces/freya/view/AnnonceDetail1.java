...
@Named
@SessionScoped
public class AnnonceDetail1 implements Serializable {
...
//               System.out.println("frooom annonce " +annonceDetail.getCar().getMatricule());
    ...
    public void annulerAnnonce() {
        this.detail.setEtat("annuler");
        this.annonceFacade.edit(this.detail);
       }
    
       public void validerAnnonce() {
        this.detail.setEtat("valider");
        this.annonceFacade.edit(this.detail);
       }
